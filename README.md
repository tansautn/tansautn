...
+ _The Journey (10+ yrs)_: Navigated through JS, PHP, Python, C#, Rust, and both Unix/Windows—and the **list is never final**.
+ _Stacks_: **Was** React, Laravel, Debian, Android. **Now on** Qt, Tauri ..., but I'm basically a _"forever student"_ of tech.
+ _Media Specialist_: Expert in **video encoding** (Br2mHD) & **audio production** (Audition, Virtual DJ).
+ _Passion_: **DJ-ing** & everything **Techs**.
+ _Mission_: Automating **every possible** workflow.
<!-- OLDS -->
...
<!--
Fullstack Dev (10+ yrs): Coded/ing in `JS`, `PHP`, `C#`, `Python`, `Rust` on `Unix`, `Windows`.
Tech Stack: React, Laravel, Python/PySide, Debian, Tampermonkey (but not limitted to...)
Media Specialist: Experienced in mHD encoding (x264) & audio processing (Audition, Virtual DJ).
Passion: DJing & Tech.
...
### Frameworks & Tools
![Qt](https://img.shields.io/badge/Qt%2FPySide6-41CD52?style=flat-square&logo=qt&logoColor=white)
...
### Media & Audio
![Adobe Audition](https://img.shields.io/badge/Adobe_Audition-9999FF?style=flat-square&logo=adobeaudition&logoColor=white)
![Virtual DJ](https://img.shields.io/badge/Virtual_DJ-E5002B?style=flat-square&logo=data:image/svg+xml;base64,PHN2ZyB4bWxucz0iaHR0cDovL3d3dy53My5vcmcvMjAwMC9zdmciIHZpZXdCb3g9IjAgMCAyNCAyNCI+PC9zdmc+&logoColor=white)
![FFmpeg](https://img.shields.io/badge/FFmpeg-007808?style=flat-square&logo=ffmpeg&logoColor=white)

---

<a href="http://zuko.pro/">
    <img src="https://zuko.pro/tmp/icon.png?v=12" alt="Z-Logo"
...
| [yt-2dlp-ext](https://github.com/7pvd/yt-2dlp-ext) | Browser extension: bring yt-dlp power into Firefox/Chrome UI | ![JavaScript](https://img.shields.io/badge/-JavaScript-F7DF1E?style=flat-square&logo=javascript&logoColor=black) | ![Maintained](https://img.shields.io/badge/Maintained-6b7280?style=flat-square) | 🤝 |
...
[![Facebook](https://img.shields.io/badge/Facebook-1877F2?style=flat-square&logo=facebook&logoColor=white)](https://fb.com/zukotnn)
[![Website](https://img.shields.io/badge/zuko.pro-000000?style=flat-square&logo=About.me&logoColor=white)](https://zuko.pro)
